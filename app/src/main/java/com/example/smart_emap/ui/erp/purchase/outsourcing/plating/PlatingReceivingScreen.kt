...
@Composable
fun PlatingReceivingScreen(viewModel: PlatingReceivingViewModel) {
    ...
    uiState.detailOrder?.let { order ->
        PlatingReceivingOrderDetailDialog(order = order, onDismiss = viewModel::dismissOrderDetail)
    }
