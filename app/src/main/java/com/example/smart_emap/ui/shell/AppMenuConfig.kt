...
/** Web Smart-EMAPs menuConfig.ts と同期 */
            ...
            children = listOf(
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("ERP_SALES_ORDERS", "受注一覧", Icons.AutoMirrored.Filled.List, "/erp/sales/orders"),
                        AppMenuNode.Leaf("ERP_SALES_FORECAST", "内示・フォーキャスト", Icons.AutoMirrored.Filled.TrendingUp, "/erp/sales/forecast"),
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("ERP_ORDER_MONTHLY", "月受注管理", Icons.AutoMirrored.Filled.List, "/erp/order/monthly"),
                        AppMenuNode.Leaf("ERP_ORDER_DAILY", "日受注管理", Icons.AutoMirrored.Filled.List, "/erp/order/daily"),
                    ...
                    children = listOf(
                        AppMenuNode.Group(
                            ...
                            children = listOf(
                                ...
                                AppMenuNode.Leaf("ERP_PURCHASE_MATERIAL_FORECAST", "内示管理", Icons.AutoMirrored.Filled.TrendingUp, "/erp/purchase/material/forecast"),
                            ),
                        ),
                        AppMenuNode.Group(
                        ...
                        AppMenuNode.Group(
                            ...
                            children = listOf(
                                ...
                                AppMenuNode.Leaf("ERP_OUTSOURCING_USAGE", "使用数管理", Icons.AutoMirrored.Filled.TrendingUp, "/erp/purchase/outsourcing/usage"),
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("ERP_INVENTORY_LIST", "製品在庫照会", Icons.AutoMirrored.Filled.List, "/erp/inventory/list"),
                        AppMenuNode.Leaf("ERP_INVENTORY_MATERIAL_LIST", "材料在庫照会", Icons.AutoMirrored.Filled.List, "/erp/inventory/material-list"),
                        AppMenuNode.Leaf("ERP_INVENTORY_PART_LIST", "部品在庫照会", Icons.AutoMirrored.Filled.List, "/erp/inventory/part-list"),
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        AppMenuNode.Group(
                            ...
                            children = listOf(
                                AppMenuNode.Leaf("ERP_PRODUCTION_DATA", "生産データ管理", Icons.AutoMirrored.Filled.List, "/erp/production/data-management"),
                                AppMenuNode.Leaf("ERP_PRODUCTION_BASELINE", "計画ベースライン", Icons.AutoMirrored.Filled.TrendingUp, "/erp/production/plan-baseline"),
                                AppMenuNode.Leaf("ERP_PRODUCTION_PLAN_SCHEDULES", "生産スケジュール", Icons.AutoMirrored.Filled.List, "/erp/production/plan-schedules"),
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("ERP_SHIPPING_LIST", "出荷構成表管理", Icons.AutoMirrored.Filled.List, "/erp/shipping/list"),
                        ...
                        AppMenuNode.Leaf("ERP_SHIPPING_CONFIRM", "出荷確認リスト", Icons.AutoMirrored.Filled.List, "/erp/shipping/confirm"),
                        ...
                        AppMenuNode.Leaf("ERP_SHIPPING_WAREHOUSE_DAILY", "倉庫日次在庫", Icons.AutoMirrored.Filled.List, "/erp/shipping/warehouse-daily"),
                    ),
                ),
            ),
        ),
        ...
        AppMenuNode.Group(
            ...
            children = listOf(
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        AppMenuNode.Leaf("APS_FORMING_PLAN_LIST", "成型計画一覧", Icons.AutoMirrored.Filled.List, "/aps/planning-list"),
                        AppMenuNode.Leaf("APS_WELDING_PLAN_LIST", "溶接計画一覧", Icons.AutoMirrored.Filled.List, "/aps/welding-planning-list"),
                    ),
                ),
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("APS_DAILY_REPORT", "日別設備計画表", Icons.AutoMirrored.Filled.List, "/aps/daily-report"),
                    ),
                ),
                AppMenuNode.Leaf(
                    code = "APS_SCHEDULING",
        ...
        AppMenuNode.Group(
            ...
            children = listOf(
                AppMenuNode.Group(
                    ...
                    icon = Icons.Default.Monitor,
                    children = listOf(
                        AppMenuNode.Leaf("MES_MONITOR_INSPECTION", "検査モニタ", Icons.Default.CheckCircle, "/mes/monitoring/inspection"),
                        AppMenuNode.Leaf("MES_MONITOR_WELDING", "溶接モニタ", Icons.Default.Build, "/mes/monitoring/welding"),
                    ),
                ),
                AppMenuNode.Group(
                ...
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        AppMenuNode.Leaf("MES_ACTUAL_REG_CUTTING", "切断実績登録", Icons.Default.Settings, "/mes/actualCollectionRegistration/cutting"),
                        AppMenuNode.Leaf("MES_ACTUAL_REG_CHAMFERING", "面取実績登録", Icons.Default.Build, "/mes/actualCollectionRegistration/chamfering"),
                        AppMenuNode.Leaf("MES_ACTUAL_REG_FORMING", "成型実績登録", Icons.Default.Inventory2, "/mes/actualCollectionRegistration/forming"),
                        AppMenuNode.Leaf("MES_ACTUAL_REG_PLATING", "メッキ実績登録", Icons.Default.Description, "/mes/actualCollectionRegistration/plating"),
                        AppMenuNode.Leaf("MES_ACTUAL_REG_WELDING", "溶接実績登録", Icons.Default.Monitor, "/mes/actualCollectionRegistration/welding"),
                        AppMenuNode.Leaf("MES_ACTUAL_REG_INSPECTION", "検査実績登録", Icons.Default.CheckCircle, "/mes/actualCollectionRegistration/inspection"),
                    ),
                ),
                AppMenuNode.Group(
            ...
            children = listOf(
                AppMenuNode.Group(
                    ...
                    children = listOf(
                        ...
                        AppMenuNode.Leaf("MASTER_PROCESS_PROCESSING_FEE", "工程加工費マスタ", Icons.AutoMirrored.Filled.TrendingUp, "/master/bom/process-processing-fee"),
                    ),
                ),
                AppMenuNode.Group(
                    code = "MASTER_BOM",
