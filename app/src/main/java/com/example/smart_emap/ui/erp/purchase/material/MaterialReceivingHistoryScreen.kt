...
fun MaterialReceivingHistoryScreen(viewModel: MaterialReceivingHistoryViewModel) {
    ...
    uiState.detailItem?.let { item ->
        MaterialReceivingDetailDialog(item = item, onDismiss = viewModel::hideDetail)
    }

    if (uiState.showColumnSettings) {
        MaterialReceivingColumnSettingsDialog(
    ...
    Scaffold(
        ...
        PurchasePageBackground {
            Column(
                ...
                MaterialReceivingHeroBar(
                    totalCount = uiState.totalCount,
                    displayCount = uiState.items.size,
                )
                MaterialReceivingSearchFilterBar(
                ...
                MaterialReceivingPaginationBar(
                    page = uiState.page,
