...
@Composable
fun UsageManagementScreen(viewModel: UsageManagementViewModel) {
    ...
    uiState.detailItem?.let { item ->
        UsageManagementDetailDialog(item = item, onDismiss = viewModel::hideDetail)
    }
    ...
    Scaffold(
        ...
        PurchasePageBackground {
            Column(
                ...
                UsageManagementHeroBar(uiState)
                UsageManagementFilters(
                    uiState = uiState,
                ...
                UsageManagementActionBar(
                    uiState = uiState,
                    onCreate = viewModel::openCreateDialog,
                    onBatch = viewModel::batchReport,
                ...
                UsageManagementTable(
                    ...
                    onDelete = viewModel::deleteUsage,
                )
                ...
                UsageManagementStatCards(uiState)
            }
        }
    }
}
